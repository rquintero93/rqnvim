    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- for LSP related items. It set:when:s the mode, buffer and description for us each time.
          ...
          map('<leader>ly', require('telescope.builtin').lsp_document_symbols, '[D]ocument s[Y]mbols')
